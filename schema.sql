...
--
-- Name: tag__id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tag_x_bottle; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tag_x_bottle__id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tag_x_bottle tag_x_bottle_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tag tag_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tag_x_bottle tag_x_bottle_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Permet de faire une transaction, qui ne sont pas supportées par le sdk supabase.
--
...
BEGIN
    ...
    LOOP
        ...
        -- supprime les anciennes données du compte
        EXECUTE format(
